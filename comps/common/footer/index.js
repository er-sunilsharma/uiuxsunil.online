      ...
      <div className="w-full bg-gray-800 py-4 text-center">
        <div className="mx-auto max-w-6xl px-4">
          <p className="text-sm font-medium text-white">
            COPYRIGHT © 2024 UIUXSUNIL.Online
          </p>
        </div>
      </div>
      <Link
        ...
        className="fixed bottom-8 md:bottom-14 right-8 md:right-14 z-50 inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#25d366]"
      >
