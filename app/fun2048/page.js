...
import ludoapp from "public/fun2048/main_view.png";
import Link from "next/link";
import Carousel from "react-multi-carousel";
import "react-multi-carousel/lib/styles.css";

export default function Fun2048() {
  const responsive = {
    superLargeDesktop: {
            ...
            <div className="mx-auto w-full md:w-2/3 space-y-10 md:space-y-24">
              <div className="space-y-4 md:space-y-5">
                ...
                <div className="text-lg md:text-base leading-8 md:leading-7 md:font-normal text-gray-700">
                  Fun 2048 is the classic 2048 puzzle game. Slide the tiles and
                  merge them to reach 2048 tile. Start with 2 and reach 16, 32,
                  128, 512, 1024 and finally 2048 and above levels Title. If you
                  like number games and number puzzle games than play free Fun
                  2048 number puzzle game! It is one of the best brain teasers
                  and brain games for adults. Enjoy different games, difficult
                  games and fun games in one brain game! 2048 puzzle game is a
                  fun free game.
                </div>
              </div>
              <div className="space-y-4 md:space-y-5">
